...
?>
  <div class="kart">
    ...
    <form method="post" enctype="multipart/form-data">
      ...
      <div class="alan">
        <label>Görsel</label>
        <img id="onizleme" src="<?= e('../' . ($d['gorsel'] ?: 'assets/img/favicon.png')) ?>" alt="" style="width:220px;height:150px;object-fit:cover;border-radius:8px;background:var(--img-bg);display:block;margin-bottom:8px">
        <input type="file" name="gorsel" accept="image/*" data-onizleme="#onizleme">
        <p class="ipucu">Yeni görsel seçmezseniz mevcut görsel korunur. Yüklenen görsel otomatik küçültülür.</p>
      </div>
      ...
      <div class="sekme-govde aktif" data-grup="h" data-sekme="tr">
      ...
      <div class="sekme-govde" data-grup="h" data-sekme="en">
